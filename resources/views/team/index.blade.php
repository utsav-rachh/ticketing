...
<div class="grid grid-cols-1 md:grid-cols-3 gap-4">
    ...
    <div class="bg-white rounded-lg shadow p-5">
        ...
        <div class="grid grid-cols-3 gap-2 text-center text-sm">
            <div><div class="font-bold text-indigo-600">{{ $stat['open'] }}</div><div class="text-gray-400 text-xs">Open</div></div>
        ...
        <a href="{{ route('team.member', $stat['user']) }}" class="mt-3 block text-center text-xs text-indigo-600 hover:underline">View Tickets &rarr;</a>
    </div>
    @empty
