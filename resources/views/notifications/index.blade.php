...
<div class="max-w-2xl mx-auto">
    ...
    <div class="bg-white rounded-lg shadow divide-y">
        ...
        <div class="p-4 {{ $notif->read_at ? 'opacity-60' : 'bg-brand-50' }}">
            ...
            <p class="text-xs text-gray-500 mt-1">Ticket: <a href="{{ route('tickets.show', $notif->data['ticket_id']) }}" class="text-brand-500 hover:underline">{{ $notif->data['ticket_number'] }}</a></p>
            @endif
