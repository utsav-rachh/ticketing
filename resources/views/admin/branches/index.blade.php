...
<div class="flex items-center justify-between mb-4">
    <h2 class="text-xl font-bold text-gray-700">Branches</h2>
    <a href="{{ route('admin.branches.create') }}" class="text-white px-4 py-2 rounded text-sm font-medium" style="background:#0056B3;">+ New branch</a>
</div>
<div class="bg-white rounded-lg shadow overflow-hidden">
    ...
    <div class="px-6 py-4 border-t">{{ $branches->links() }}</div>
</div>
@endsection
