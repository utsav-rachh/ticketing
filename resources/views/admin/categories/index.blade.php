...
<div class="flex justify-between items-center mb-4 flex-wrap gap-2">
    <h2 class="text-lg md:text-xl font-bold text-gray-700">Categories</h2>
    <a href="{{ route('admin.categories.create') }}" class="text-white px-4 py-2 rounded text-sm font-medium btn-touch" style="background:#0056B3;">+ New category</a>
</div>
    ...
    <div class="bg-white rounded-lg shadow p-4 md:p-6">
        ...
        <div class="space-y-3">
            ...
            <details class="border rounded p-3">
                <summary class="cursor-pointer font-medium text-gray-700 flex flex-col sm:flex-row sm:justify-between gap-2">
                ...
                <div class="mt-2 pl-3 text-sm text-gray-600 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-1">
