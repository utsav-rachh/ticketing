        ...
        <header class="app-header bg-white border-b border-gray-200 border-t-2 border-t-brand-500 flex items-center justify-between flex-shrink-0">
            ...
            <div class="flex items-center gap-3 md:gap-4">
                ...
                <a href="{{ route('developer.home') }}"
                   class="hidden sm:inline-flex items-center gap-1 text-xs font-medium text-slate-600 hover:text-brand-600 border border-slate-300 rounded-md px-2 py-1"
                   title="Back to the app launcher">
