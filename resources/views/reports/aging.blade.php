...
<div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    <h2 class="text-lg md:text-xl font-bold text-gray-700">Ticket Aging</h2>
...
<form method="GET" class="bg-white shadow rounded p-3 flex flex-wrap items-end gap-3 mb-6">
    ...
    <a href="{{ route('reports.aging') }}" class="bg-gray-100 text-gray-600 px-3 py-2 rounded text-sm btn-touch">Clear</a>
</form>
