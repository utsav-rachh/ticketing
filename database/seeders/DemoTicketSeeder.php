...
class DemoTicketSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $tickets = [
            // 1. Open application ticket, unassigned
            [
                ...
                'tat_hours'     => 4,
                'activities'    => [
                    ['action_type' => 'created', 'description' => 'Ticket created by ' . $md->name, 'user' => $md, 'at' => Carbon::now()->subHours(1)],
                ],
            ],

            // 2. Assigned application ticket
            [
                ...
                'tat_hours'     => 8,
                'activities'    => [
                    ['action_type' => 'created',  'description' => 'Ticket created by ' . $md->name,    'user' => $md,    'at' => Carbon::now()->subHours(6)],
            ...
            // 3. In-progress infra ticket, with vendor + vendor_reference
            [
                ...
                'subject'       => 'Server RAID degraded — Mumbai DC',
                ...
                'tat_hours'     => 24,
                'activities'    => [
                    ['action_type' => 'created',  'description' => 'Ticket created by ' . $md->name,     'user' => $md,      'at' => Carbon::now()->subDays(1)->subHours(2)],
            ...
            // 4. On-hold infra ticket (hold paused clock)
            [
                ...
                'subject'       => 'Core switch packet loss',
                ...
                'tat_hours'     => 12,
                'activities'    => [
                    ['action_type' => 'created',  'description' => 'Ticket created',                   'user' => $md,      'at' => Carbon::now()->subDays(2)->subHours(3)],
            ...
            [
                ...
                'tat_hours'     => 8,
                'activities'    => [
                    ['action_type' => 'created',  'description' => 'Ticket created',                      'user' => $md,    'at' => Carbon::now()->subDays(3)->subHours(1)],
            ...
            [
                ...
                'tat_hours'     => 24,
                'activities'    => [
                    ['action_type' => 'created',  'description' => 'Ticket created',                         'user' => $md,                   'at' => Carbon::now()->subDays(5)->subHours(2)],
                ...
                'updates' => [
                    ...
                    ['status_from' => 'resolved', 'status_to' => 'closed',   'note' => 'Confirmed receipt, closing ticket.', 'user' => $md,               'at' => Carbon::now()->subDays(3)],
                ],
            ],

            // 7. TAT-violated critical infra ticket (unresolved, deadline passed)
            [
                ...
                'branch_id'     => $anyBranch?->id,
                'vendor_id'     => $dellVendor?->id,
                'subject'       => 'UPS battery failure in Mumbai DC',
            ...
            // 9. Infra ticket with pending expense
            [
                ...
                'tat_hours'     => 16,
                'activities'    => [
                    ['action_type' => 'created',      'description' => 'Ticket created',                          'user' => $md,       'at' => Carbon::now()->subDays(1)->subHours(4)],
            ...
            // 10. Pending info - employee ticket waiting on info
            [
                ...
                'tat_hours'     => 8,
                'activities'    => [
                    ['action_type' => 'created',        'description' => 'Ticket created',                'user' => $md,    'at' => Carbon::now()->subHours(5)],
